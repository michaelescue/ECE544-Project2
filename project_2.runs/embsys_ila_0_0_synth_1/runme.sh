...
HD_PWD='C:/Users/ME/Vivado_Projects/project_2/project_2.runs/embsys_ila_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log embsys_ila_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source embsys_ila_0_0.tcl
